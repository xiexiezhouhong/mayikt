...
/*  794 */.arrayIndexScale(Object[].class);
    ...
    public final long getAndAddLong(Object paramObject, long paramLong1, long paramLong2) {
        ...
        while (true) {
            /* 1053 */
            long l = getLongVolatile(paramObject, paramLong1);
            /* 1054 */
            if (compareAndSwapLong(paramObject, paramLong1, l, l + paramLong2))
                /* 1055 */ return l;
            /*      */
        }
        /*      */
    ...
    public final int getAndSetInt(Object paramObject, long paramLong, int paramInt) {
        ...
        while (true) {
            ...
            int i = getIntVolatile(paramObject, paramLong);
            /* 1073 */
            if (compareAndSwapInt(paramObject, paramLong, i, paramInt))
                /* 1074 */ return i;
            /*      */
        }
        /*      */
    ...
    public final long getAndSetLong(Object paramObject, long paramLong1, long paramLong2) {
        ...
        while (true) {
            ...
            long l = getLongVolatile(paramObject, paramLong1);
            /* 1092 */
            if (compareAndSwapLong(paramObject, paramLong1, l, paramLong2))
                /* 1093 */ return l;
            /*      */
        }
        /*      */
    ...
    public final Object getAndSetObject(Object paramObject1, long paramLong, Object paramObject2) {
        ...
        while (true) {
            /* 1110 */
            Object object = getObjectVolatile(paramObject1, paramLong);
            /* 1111 */
            if (compareAndSwapObject(paramObject1, paramLong, object, paramObject2))
                /* 1112 */ return object;
            /*      */
        }
        /*      */
...
/* Location:              D:\path\jdk\jdk8\jre\lib\rt.jar!\sun\misc\Unsafe.class
